...
/**
 * Inline stroke icons (24×24 grid). Kept dependency-free on purpose.
 * Add new icons to ICON_PATHS; each entry is the SVG children markup.
 */
const ICON_PATHS = {
  alertTriangle: (
    <>
  ...
  eye: (
    <>
      <path d="M2.06 12.35a1 1 0 0 1 0-.7C3.42 8.43 7.36 5 12 5s8.58 3.43 9.94 6.65a1 1 0 0 1 0 .7C20.58 15.57 16.64 19 12 19s-8.58-3.43-9.94-6.65" />
...
export function Icon({ name, size = 18, label, strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg
